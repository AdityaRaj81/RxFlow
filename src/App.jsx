                ...
                <>
                  ...
                  {user.role === 'admin' && (
                    <>
                      ...
                      <Link to="/staff-management" className="nav-button">
                        Staff
                      </Link>
                    </>
                  )}
        ...
        <div className="features-grid">
          {[
            ...
            },
            {
              ...
              title: 'Easy Billing',
              description:
                'Streamlined billing process with instant invoice generation',
            },
            {
              icon: '📱',
              title: 'Mobile Ready',
      ...
      <section id="about" className="about-section">
        ...
        <div className="about-content">
          ...
          >
            <h3>Our Mission</h3>
            <p>
              To revolutionize pharmacy management through innovative technology
              solutions that enhance efficiency and patient care.
            </p>

            <h3>Our Vision</h3>
            <p>
              To be the leading provider of pharmacy management solutions,
              empowering pharmacists to focus on what matters most - their
              patients.
            </p>
